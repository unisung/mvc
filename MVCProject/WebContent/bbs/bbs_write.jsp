...
<div id="article_c">
<div id="write_wrap">
<h2 class="write_title">자료실 글쓰기 폼</h2>
<form action="bbs_write_ok.do" name="f" method="post" onsubmit="return bbs_check()"
 ...
 <table id="write_t">
  ...
  <input type="text" name="bbs_name" id="bbs_name" class="input_box" size="14">
   ...
   <th>글내용</th>
   <td>
   <textarea type="text" name="bbs_content" id="bbs_content" 
 ...
 <div id="write_menu">
   ...
   <input type="reset" value="취소" onclick="$('#bbs_name').focus();" class="input_button"/>
 </div>
</form> 
</div>
</div>
